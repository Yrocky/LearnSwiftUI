//
//  DoAnimationViewModifer.swift
//  DoSwiftUI
//
//  Created by rocky on 2020/12/30.
//

import SwiftUI

struct DoAnimationViewModifer: View {
...
struct DoAnimationViewModifer_Previews: PreviewProvider {
    static var previews: some View {
        DoAnimationViewModifer()
    }
}
